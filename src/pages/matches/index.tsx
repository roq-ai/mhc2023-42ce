              ...
              <Thead>
                <Tr>
                  ...
                  {hasAccess('team', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                    <Th>team_match_team_a_idToteam</Th>
                  )}
                  {hasAccess('team', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                    <Th>team_match_team_b_idToteam</Th>
                  )}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('team', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/teams/view/${record.team_match_team_a_idToteam?.id}`}>
                          {record.team_match_team_a_idToteam?.name}
                        </Link>
                      </Td>
                    )}
                    {hasAccess('team', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/teams/view/${record.team_match_team_b_idToteam?.id}`}>
                          {record.team_match_team_b_idToteam?.name}
                        </Link>
                      </Td>
                    )}
