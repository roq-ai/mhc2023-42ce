    ...
    () =>
      getTeams({
        relations: [
          'organization',
          'user',
          'match_match_team_a_idToteam.count',
          'match_match_team_b_idToteam.count',
          'player.count',
        ],
      }),
  );
              ...
              <Thead>
                <Tr>
                  ...
                  {hasAccess('match', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                    <Th>match_match_team_a_idToteam</Th>
                  )}
                  {hasAccess('match', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                    <Th>match_match_team_b_idToteam</Th>
                  )}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('match', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.match_match_team_a_idToteam}</Td>
                    )}
                    {hasAccess('match', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.match_match_team_b_idToteam}</Td>
                    )}
